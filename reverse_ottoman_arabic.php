...
if($pbreak !== false  && $lbreak !== false) {
	$input = str_replace("**", "</div>\n</p>\n<p>\n<div style=\"font-size:".$size."px; dir: rtl;\">", $input);
	}
...
echo "<html>\n<head>\n<title>$htitle</title>\n";
echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"style_arabic.css\" />\n";
echo "</head>\n<body>\n";
//use the font size
echo "<div style=\"width:720px;font-size:".$size."px\">\n";
echo "<p style=\"font-size:".$size."px; text-align:left;\">$title<br/>$author<br/>$date<br/>$responsibility</p></br/>\n";

//take care of the various possibilities of line or line group
if($pbreak !== false) { echo "<p>\n"; }
if($lbreak !== false && $pbreak === false) { echo "<p>\n"; }
if($lbreak === false && $pbreak === false) { echo "<p>"; }
if($lbreak !== false) { echo "<div style=\"font-size:".$size."px; dir: rtl;\">"; }
echo $input;
